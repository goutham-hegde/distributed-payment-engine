 ...
 *
 * <p>A copy of account-service's helper of the same name, and copied on purpose. Sharing it would
 * mean either a test-jar dependency between two services or a fourth module existing only to hold
 * sixty lines of test scaffolding - both of which couple the services together for less than the
 * duplication costs. Production code is shared through common-messaging because sharing it buys a
 * guarantee; this buys convenience.
 */
